...
class EditorSerializer(serializers.HyperlinkedModelSerializer):
   # country_id = serializers.StringRelatedField(many=True)
    class Meta:
        model = Editor
        fields = ['id','url','name', 'country_id']
...
class BookSerializer(serializers.HyperlinkedModelSerializer):
  #  author = serializers.StringRelatedField(many=True)
   # genres = serializers.StringRelatedField(many=True)
    class Meta:
        model = Book
        fields = ['isbn','url','isbn','book_name','book_plot','book_pages_number','book_release_date','book_language','book_image','author','genres']
